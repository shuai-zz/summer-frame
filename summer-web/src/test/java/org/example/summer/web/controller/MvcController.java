...
public class MvcController {
    ...
    @GetMapping("/greeting")
    @ResponseBody
    String greeting(@RequestParam(value="action", defaultValue = "Hello") String action,
    ...
    @ResponseBody
    byte[] download(@PathVariable("file") String file, @RequestParam("time") Float downloadTime,
