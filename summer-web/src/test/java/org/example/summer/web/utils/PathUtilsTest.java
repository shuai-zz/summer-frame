package org.example.summer.web.utils;
...
public class PathUtilsTest {
    ...
    void invalidPath() throws Exception{
        assertThrows(ServletException.class, ()->PathUtils.compile("/no-name/{}"));

        assertThrows(ServletException.class, ()->PathUtils.compile("/starts-with-digit/{123}/"));

        assertThrows(ServletException.class, ()->PathUtils.compile("/invalid-name/{user_id}"));

        assertThrows(ServletException.class, ()->PathUtils.compile("/missing-right/{user/"));

        assertThrows(ServletException.class, ()->PathUtils.compile("/missing-left/user}/"));
    }
}
